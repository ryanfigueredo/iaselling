...
const features = [
  ...
  },
  {
    ...
    description: 'Atendimento via Discord/WhatsApp para membros',
    icon: MessageCircle,
  },
]
        ...
        >
          {features.map((feature, index) => (
            <motion.div
              ...
              whileHover={{ y: -4 }}
              className="group glass rounded-2xl p-6 neon-border card-hover border border-white/[0.06]"
            >
              <div className="w-12 h-12 rounded-xl bg-neon-green/10 border border-neon-green/20 flex items-center justify-center mb-4 group-hover:bg-neon-green/15 group-hover:border-neon-green/30 transition-colors">
